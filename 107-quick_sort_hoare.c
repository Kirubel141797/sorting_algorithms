...
/**
 * swap_ints - A swap two integers in an array.
...
/**
 * hoare_partition - A order a subset of an array of integers
...
/**
 * quick_sort_hoare - A sort an array of integers in ascending
