...
/**
 * radix_counting_sort - A sort the significant digits of an array of integers
 *                       in ascending order using the counting sort algorithm.
 * @array: array of integers.
 * @size: A size of the array.
 * @sig: A significant digit to sort on.
...
/**
 * radix_sort - A sort an array of integers in ascending
